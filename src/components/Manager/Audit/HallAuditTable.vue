      ...
      <div class="table">
        <el-table :data="record">
            ...
            <template slot-scope="props">
              <el-form label-position="left" inline class="table-expand">
                ...
                <el-form-item label="备注">
                  <span>
                    {{
                      props.row.remarks.length === 0 ? '无' : props.row.remarks
                    }}
                  </span>
                </el-form-item>
          ...
          <el-table-column
            ...
            min-width="90"
          ></el-table-column>
          <el-table-column label="会议类型" min-width="90">
      ...
      this.$axios
        ...
        .then((successResponse) => {
          ...
          this.record.forEach((record) => {
            ...
            // 设置参会领导和提供服务的字符串
            const leaders = record['leaderStr'].split(',')
            const services = record['provideStr'].split(',')
            record['leaderStr'] = leaders
              .slice(0, leaders.length - 1)
              .join('，')
            record['provideStr'] = services
