<template>
  <div class="notification-container">
    <el-dialog
      v-show="
        !applyFormVisible && !batchApplyFormVisible && !hallApplyFormVisible
      "
    ...
    >
      <div>
        ...
        <p>
          二、纪律方面：报告和会议内容严格遵守国家关于意识形态和涉外等方面的相关规定和纪律要求。不非法集会、传教、传销，宣讲与学术报告或与申请登记的会议内容不符的内容，不从事广告宣传、商品推销等商业活动。
        </p>
        <p>
          三、墙面方面：背景按照要求在指定地点安装，安全自负。维护馆内安静、文明的环境，不乱丢、乱写、乱画、乱贴，如违规粘贴未清理的，同意按污损面积进行赔偿。
        </p>
        <p>
          四、防火安全责任：按会场允许容量安排人数，不擅自增加人数和座位；不随意移动场馆内的桌椅等设施设备；不在场馆内乱堆、乱放，堵塞通道；不另接电器，不在场内吸烟，不使用明火；不将易燃、易爆品和有毒物带入馆内。
        </p>
        <p>
          五、食品安全责任：严格遵守场馆的规定，不将饮料、食品带入会议室内食用；自办茶点或茶歇须事先申报，饮食安全自负。
        </p>
        <p>
          六、治安责任：确保会议内容、形式，文明健康，场地秩序井然；对场内治安负全责，有治安隐患的须事先做预案，发生治安事件及时处理。负责参会人员和会议室内财物的安全，避免财物丢失。会议中指定专人负责安全工作，落实具体责任，确保安全责任落到实处。
        </p>
  ...
  methods: {
    ...
    showApplyForm() {
      if (this.type === 'hall') {
        ...
        this.isBatch
          ? (this.batchApplyFormVisible = true)
